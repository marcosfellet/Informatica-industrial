...
class ServidorMT(Servidor): #herança
    """
    ...
    def start(self):
        ...
        try:
            ...
            while True:
                con, client = self.__tcp.accept()
                #cria nova thread para a instrução bloqueante:
                self.__threadPool[client] = threading.Thread(target=self._service,args=(con,client))# dicionário com o ip da 
                #
