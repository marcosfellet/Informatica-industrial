...
class NomedaClasse:
    def __init__(self.arg1, ar2): #self = this, o self e necessario de ser passado
        self.attr1 = arg1
        self.attr2 = ar2
    def metodo1(self):
        expressoes
...
# 2 underlines na frente = private
# 1 = protected
# 0 = public
  #construtor
    __init__()
  #destrutor
    __del()__ # nao tao necessario devido ao garbage collector
